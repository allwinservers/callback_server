...
from apps.lastpass.utils import LastPass_JLF,LastPass_TY,LastPass_DD,LastPass_YZL,LastPass_OSB,LastPass_BAOZHUANKA,LastPass_LIMAFU,LastPass_JUXING,LastPass_MK
    ...
    def select_pass(self):
        ...
        # JUXING
            ...
            request_data = {
                ...
                "notifyUrl": url_join('/api/lastpass/juxing_callback')
            }
        ...
        # MK
            ...
            request_data = {
                "pay_orderid": str(self.order.ordercode),
                "pay_amount": self.order.amount,
                "pay_notifyurl": url_join('/api/lastpass/mk_callback'),
                "pay_bankcode": pay_bankcode
            }
